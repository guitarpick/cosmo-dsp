/* 	
 ---------------------------------------------------------------
	...
	Arguments: 	Threshold, Delay Time Min, Delay Time Max, Feedback Min, Feedback Max, 
				Stereo Width, Level, Portamento time, Center freq, Bandwidth  
